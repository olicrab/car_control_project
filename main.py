"""Точка входа основного приложения: инициализирует геймпад, ZED-камеру и
контроллер автомобиля, управляет главным циклом и текстовым интерфейсом
на curses, переключая режимы между ручным управлением и ZED-автопилотом."""
