...
def main():
    ...
    print("Левый стик: поворот, триггеры: газ (вперёд)/тормоз, бамперы: смена передачи, Start: режим, A: запись, B: задняя передача, Q: выход")
    ...
    try:
        while True:
            ...
            controller.update(speed, brake, steering)  # Исправлено: добавлен brake
