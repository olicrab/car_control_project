"""Источник управляющих команд с геймпада: читает оси/кнопки через pygame,
обрабатывает события кнопок и формирует нормализованные значения газа,
тормоза и поворота с учётом трима."""
